        ...
        try {
            ...
            if(response.getStatusLine().getStatusCode() == 200){
                ...
                if (entity != null){ 
                    ...
                    if(contentType==null){
                       System.out.println("Warning: Content type is not known, assuming serialization is available") ;
                       return true;
                    }
//                String contentType = response.getFirstHeader("Content-Type").getValue();
                    if(contentType.toString().contains(serialization)){
...
//            System.out.println(queryLOV);
            ...
            if(results.hasNext()){
                ...
                v.setLovURI("https://lov.linkeddata.es/dataset/lov/vocabs/"+v.getPrefix());
                qe.close();
                return true;
            }
            qe.close();
...
//            System.out.println("Vocab "+v.getUri()+" loaded successfully!");
    ...
    private static void doContentNegotiation(OntModel model,Vocabulary v, String accept, String serialization){
        try{
            ...
            connection.setInstanceFollowRedirects(false);//if you follow all redirects this will produce an error
